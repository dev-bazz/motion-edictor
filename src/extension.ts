...
<body>
	<div class="container">
		...
		<div class="editor-section">
			<div class="canvas-wrapper">
				<small style="margin-bottom: 8px; color: var(--vscode-descriptionForeground);">Draw your easing curve on the canvas</small>
	...
	<script>
		...
		// Default control points for cubic-bezier
		let controlPoints = [
			{ x: 0.25, y: 0.9 },    // Point 1
			{ x: 0.75, y: 0.1 }     // Point 2
		];
		...
		function updatePreview() {
			...
			setTimeout(() => {
				previewBox.style.animation = \`slide 2s cubic-bezier(\${x1}, \${y1}, \${x2}, \${y2}) infinite\`;
			}, 10);
		}
